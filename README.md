...
1. Edit `app.py` to point to your saved model path:
...
4. Upload a retinal image to see the classification and heatmap.
...
1. **EfficientNetV2:** Tan, M., & Le, Q. V. (2021). "Smaller Models and Faster Training."
2. **Grad-CAM:** Selvaraju, R. R., et al. (2017). "Visual Explanations from Deep Networks via Gradient-Based Localization."
3. **Retinex Theory:** Rahman, Z., et al. (2016). "Retinex Theory Based Adaptive Filter for Color Correction."

---

## ⚠️ Disclaimer

**This project is for educational and research purposes only.** It is not a certified medical device and should not replace professional medical diagnosis. Always consult qualified healthcare professionals for medical decisions.
